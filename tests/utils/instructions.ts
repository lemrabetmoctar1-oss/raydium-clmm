...
export class InstructionHelper {
  ...
  /**\n   * Increase Liquidity helper function\n   */\n  async increaseLiquidity(params: {\n    owner: Keypair;\n    poolState: PublicKey;\n    liquidity: anchor.BN;\n    amount0Max: anchor.BN;\n    amount1Max: anchor.BN;\n    tokenVault0Mint: PublicKey;\n    tokenVault1Mint: PublicKey;\n  }) {\n    const poolStateData = await this.program.account.poolState.fetch(params.poolState);\n    \n    const [personalPosition] = await this.pda.getPersonalPositionStatePDA(params.tokenVault0Mint);\n    // We need the actual position NFT mint - this is a simplification\n    // In practice, we'd need to track the position NFT mint from openPosition\n    \n    // For now, use program method directly\n    const protocolPosition = await this.pda.getProtocolPositionStatePDA(\n      params.poolState,\n      -1000, // tickLower\n      1000   // tickUpper\n    );\n    \n    const [tickArrayLower] = await this.pda.getTickArrayStatePDA(\n      params.poolState,\n      -1000\n    );\n    const [tickArrayUpper] = await this.pda.getTickArrayStatePDA(\n      params.poolState,\n      1000\n    );\n    \n    const [tokenVault0] = await this.pda.getTokenVaultPDA(params.poolState, params.tokenVault0Mint);\n    const [tokenVault1] = await this.pda.getTokenVaultPDA(params.poolState, params.tokenVault1Mint);\n    \n    const recipientTokenAccount0 = getAssociatedTokenAddressSync(params.tokenVault0Mint, params.owner.publicKey);\n    const recipientTokenAccount1 = getAssociatedTokenAddressSync(params.tokenVault1Mint, params.owner.publicKey);\n    \n    return await this.program.methods\n      .increaseLiquidity(params.liquidity, params.amount0Max, params.amount1Max)\n      .accounts({\n        nftOwner: params.owner.publicKey,\n        poolState: params.poolState,\n        personalPosition: personalPosition,\n        protocolPosition: protocolPosition,\n        tokenVault0: tokenVault0,\n        tokenVault1: tokenVault1,\n        tickArrayLower: tickArrayLower,\n        tickArrayUpper: tickArrayUpper,\n        recipientTokenAccount0: recipientTokenAccount0,\n        recipientTokenAccount1: recipientTokenAccount1,\n        tokenProgram: TOKEN_PROGRAM_ID,\n      } as any)\n      .signers([params.owner])\n      .rpc();\n  }\n\n  /**\n   * Decrease Liquidity helper function\n   */\n  async decreaseLiquidity(params: {\n    poolState: PublicKey;\n    positionNftMint: PublicKey;\n    positionNftAccount: PublicKey;\n    personalPosition: PublicKey;\n    liquidity: anchor.BN;\n    amount0Min: anchor.BN;\n    amount1Min: anchor.BN;\n    tokenVault0Mint: PublicKey;\n    tokenVault1Mint: PublicKey;\n    tickArrayLower: PublicKey;\n    tickArrayUpper: PublicKey;\n  }) {\n    const poolStateData = await this.program.account.poolState.fetch(params.poolState);\n    \n    const protocolPosition = await this.pda.getProtocolPositionStatePDA(\n      params.poolState,\n      -1000,\n      1000\n    );\n    \n    const [tokenVault0] = await this.pda.getTokenVaultPDA(params.poolState, params.tokenVault0Mint);\n    const [tokenVault1] = await this.pda.getTokenVaultPDA(params.poolState, params.tokenVault1Mint);\n    \n    const recipientTokenAccount0 = getAssociatedTokenAddressSync(params.tokenVault0Mint, (await this.program.account.personalPositionState.fetch(params.personalPosition)).owner);\n    const recipientTokenAccount1 = getAssociatedTokenAddressSync(params.tokenVault1Mint, (await this.program.account.personalPositionState.fetch(params.personalPosition)).owner);\n    \n    return await this.program.methods\n      .decreaseLiquidity(params.liquidity, params.amount0Min, params.amount1Min)\n      .accounts({\n        nftOwner: (await this.program.account.personalPositionState.fetch(params.personalPosition)).owner,\n        nftAccount: params.positionNftAccount,\n        personalPosition: params.personalPosition,\n        poolState: params.poolState,\n        protocolPosition: protocolPosition,\n        tokenVault0: tokenVault0,\n        tokenVault1: tokenVault1,\n        tickArrayLower: params.tickArrayLower,\n        tickArrayUpper: params.tickArrayUpper,\n        recipientTokenAccount0: recipientTokenAccount0,\n        recipientTokenAccount1: recipientTokenAccount1,\n        tokenProgram: TOKEN_PROGRAM_ID,\n      } as any)\n      .signers([(await this.program.account.personalPositionState.fetch(params.personalPosition)).owner])\n      .rpc();\n  }\n\n  /**\n   * Close Position helper function\n   */\n  async closePosition(params: {\n    poolState: PublicKey;\n    positionNftMint: PublicKey;\n    positionNftAccount: PublicKey;\n    personalPosition: PublicKey;\n    nftOwner: PublicKey;\n  }) {\n    return await this.program.methods\n      .closePosition()\n      .accounts({\n        nftOwner: params.nftOwner,\n        positionNftMint: params.positionNftMint,\n        positionNftAccount: params.positionNftAccount,\n        personalPosition: params.personalPosition,\n        poolState: params.poolState,\n      } as any)\n      .signers([{ publicKey: params.nftOwner }] as any)\n      .rpc();\n  }\n\n  /**\n   * Close Limit Order helper function\n   * Closes the limit order account when unfilled amount is zero\n   */\n  async closeLimitOrder(params: { owner: Keypair; limitOrder: PublicKey }) {
